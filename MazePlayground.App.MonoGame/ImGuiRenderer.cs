...
namespace MazePlayground.App.MonoGame
{
    ...
    public class ImGuiRenderer
    {
        ...
        /// <summary>
        /// Creates a pointer to a texture, which can be passed through ImGui calls such as <see cref="MazePlayground.App.MonoGame.ImGui.Image" />. That pointer is then used by ImGui to let us know what texture to draw
        /// </summary>
